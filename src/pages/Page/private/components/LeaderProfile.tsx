...
const LeaderProfile = (props: ILeaderProfile) => {
  ...
  return (
    <>
      <Grid item xs={12} sm={6} md={6} lg={6} className="page-home-form-field people-form-wrapper">
        <form
        ...
        >
          ...
          <Grid item xs={8} sm={8} md={7} lg={8} className="people-form-area">
            ...
            <div className="controls">
              {leaderId && (
                <span className="span-link" onClick={() => setConfirmModalVisible(true)}>Delete</span>
              )}
              <Button className="btn-small" type="submit" disabled={props.isParentAdmin} loading={loading}>Save</Button>
            </div>
          </Grid>
