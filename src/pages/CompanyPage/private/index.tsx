      ...
      >
        ...
        <div className="shadow-box">
          ...
          <div className="company-profile-leaders">
            <hr className="company-profile-leaders-line" />
            <InputLabel className="leader-header">Company Leaders</InputLabel>
          ...
          <div className="company-profile-videos">
            <div className={`page-form-video-wrapper ${videoClass}`}>
              <InputLabel className="video-header">Company Videos</InputLabel>
              <Grid container spacing={2} xs={12}>
                {[0, 1, 2].map((videoId) => (
                  <CompanyVideos
                    key={videoId}
