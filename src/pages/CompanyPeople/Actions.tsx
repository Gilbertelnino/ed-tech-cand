  ...
  return (
    <div className='custom-tab-wrapper'>
      ...
      <div className='custom-tab-right'>
        ...
        <Button onClick={() => handleClick('Add')} color="secondary" className={'custom-tab-save-btn save-button'}>Save</Button>
        <Button onClick={() => handleClick('Publish')} className="publish-button">Publish</Button>
      </div>
    </div>
  );
};
