...
const Cards = (props) => {
  ...
  if (loading) {
    ...
    cards = (data || []).map((admin) => {
      ...
      const adminTitle = _.get(admin, "jobTitle.title", "recruiter");
            ...
            <div className="admin-card-header">
              <div className="admin-card-header-iner-wrap">
                ...
                <div className="admin-card-intro">
                  <div className="admin-card-intro-inner">
                  ...
                  <div className="admin-card-profile-msg-btn">
                      <Button className="btn-small  btn-transparent" onClick={() => handleOpen(adminId)} disabled={isInactive}>Profile</Button>
                      <Button variant="outlined" className="btn-small pink-btn btn-small-transparant1" disabled={isInactive}>Message</Button>
                  </div>
                </div>
              </div>
